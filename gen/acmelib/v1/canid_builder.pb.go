...
const file_acmelib_v1_canid_builder_proto_rawDesc = "" +
	"\n" +
	"\x1eacmelib/v1/canid_builder.proto\x12\n" +
	"acmelib.v1\x1a\x17acmelib/v1/entity.proto\"j\n" +
	"\x0eCANIDBuilderOp\x122\n" +
	"\x04kind\x18\x01 \x01(\x0e2\x1e.acmelib.v1.CANIDBuilderOpKindR\x04kind\x12\x12\n" +
	...
	"\n" +
	"operations\x18\x02 \x03(\v2\x1a.acmelib.v1.CANIDBuilderOpR\n" +
	"operations*\xd4\x01\n" +
	...
	"\x0ecom.acmelib.v1B\x11CanidBuilderProtoP\x01Z\x14acmelib/v1;acmelibv1\xa2\x02\x03AXX\xaa\x02\n" +
	"Acmelib.V1\xca\x02\n" +
...
var (
	...
	file_acmelib_v1_canid_builder_proto_rawDescData []byte
)

func file_acmelib_v1_canid_builder_proto_rawDescGZIP() []byte {
	file_acmelib_v1_canid_builder_proto_rawDescOnce.Do(func() {
		file_acmelib_v1_canid_builder_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_acmelib_v1_canid_builder_proto_rawDesc), len(file_acmelib_v1_canid_builder_proto_rawDesc)))
	})
...
var file_acmelib_v1_canid_builder_proto_goTypes = []any{
...
func file_acmelib_v1_canid_builder_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_acmelib_v1_canid_builder_proto_rawDesc), len(file_acmelib_v1_canid_builder_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
